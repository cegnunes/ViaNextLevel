package br.com.kadu.nextlevelkadu.config;
...
import br.com.kadu.nextlevelkadu.repository.RotaDeEntregaRepository;
import br.com.kadu.nextlevelkadu.repository.TipoDeAtividadeRepository;

@Profile("dev")
@Configuration

public class BancoPopulate {
	@Autowired
...
//		clienteRepository.save(cliente6);
	    ...
	    int fimDoCpf = 0;
		for (int i = 1; i < 50; i++) {
			clienteRepository.save(new Cliente(null, "Cliente " + i, "123456789" + (fimDoCpf + i)));
		}
